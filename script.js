(function () {
    ...
    - New Weapons: Devastator, Scatter, Evora, and Veyron<br><br>
   ...
   - Bug Fixes<br><br>
    ...
    var shapeData = [{
        ...
        healthData: {
            base: 64e3,
            level: [0, 1e3, 1e3, 1e3, 1e3, 2e3, 2e3, 2e3, 3e3, 3e3, 4e3, 6e3],
        },
        ability: {
            name: "Paladin",
            desc: `
                        ...
                        if (robot.ability.name == "Retribution" || robot.ability.name == "Paladin") {
                            if(robot.ability.name == "Paladin") {
                                if(robot.shields[0] && robot.shields[0].health > 0) {
                                    let increase = Math.min(robot.shields[0].health / 50, 48e3);
    ...
    function changeHealth(object, {amount, graydmg}, isPlayer, doer, noDefense) {
        try {
