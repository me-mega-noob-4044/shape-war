(function () {
    ...
    - Changed Reward Amount for Gold and Silver (if you have an operation on going, you'll have to finish it to get the update.<br>
    ...
    document.addEventListener("keydown", (e) => {
        ...
        if (parseInt(e.key) <= 8 && parseInt(e.key) >= 1) {
            if(window.isDev) addOperationXP(300e3);
