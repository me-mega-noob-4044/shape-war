(function () {
   ...
   - Bug Fixes<br><br>
    ...
    var moduleData = [{
        ...
        imageSource: "./images/fortifier.png",
        cost: {
            sliver: 500e3,
            gold: 2e3
        }
        ...
        imageSource: "./images/damage_controller.png",
        cost: {
            sliver: 25e6,
            gold: 5e3
        }
    ...
    function updateMoneyDisplay(index, value) {
        ...
        Gold: ${abbreviateNumber(player.gold)} | Workshop Points: ${player.workshopPoints}<br>
    ...
    document.getElementById("workshopToggle").onclick = function () {
        ...
        <div style="position: absolute; top: 90px; left: 150px;">
        Production Cost: 200.0K Silver
        </div>
        </div>
        `;
        updateProductionDisplay();
        document.getElementById("produceWP").onclick = function() {
            if(player.sliver - 200e3 >= 0) {
                updateMoneyDisplay("sliver", -200e3);
                workshopQueue.push({
                    amount: 40,
                    duration: (window.isDev ? 1e3 : 5 * 60 * 1e3)
                });
                updateProductionDisplay();
            }
        }
