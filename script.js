   ...
   - Bug Fixes<br><br>
    ...
    class shape {
        constructor(data, slot, dontSID) {
            ...
            if (data.ability) {
                ...
                if (data.ability.name == "Reinforce Hull") {
                ...
                } else if (data.ability.name == "Paladin" || data.ability.name == "Stealth Dash" || data.ability.name == "Phase Shift" || data.ability.name == "Dash" || data.ability.name == "Fortify") {
    ...
    var shapeData = [{
        ...
        ability: {
            ...
            shieldHpData: {
                base: 30e3,
                level: [0, 4e3, 4e3, 10e3, 12e3, 12e3, 12e3, 12e3, 14e3, 18e3, 20e3, 24e3],
            },
            charges: 4,
            lastingTime: 25e2,
            reload: 12e3
        ...
        ability: {
            ...
            abilityHealthMultiData: {
                base: 2,
                level: [0, .5, .5, .5, .5, .5, .5, 2, 2, 2, 4, 5]
            },
            abilityDefensePointsData: {
                base: 100,
                level: [0, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 150]
            },
            lastingTimeData: {
                base: 6e3,
    ...
    var weaponData = [{
        ...
        damageData: {
            base: 390,
            level: [0, 65, 65, 65, 65, 65, 78, 78, 78, 78, 78, 78]
        },
        ...
        damageData: {
            base: 680,
            level: [0, 130, 130, 130, 130, 130, 156, 156, 156, 156, 156, 156]
        },
        ...
        damageData: {
            base: 20,
            level: [0, 5, 5, 5, 5, 5, 5, 5, 5, 5, 10, 15]
        },
        dotData: {
            base: 50,
            level: [0, 10, 10, 10, 15, 15, 15, 20, 25, 30, 35, 40],
        },
        ...
        dotData: {
            base: 125,
            level: [0, 15, 15, 15, 20, 20, 20, 20, 25, 30, 35, 40],
        },
        ...
        damageData: {
            base: 300,
            level: [0, 300, 320, 350, 390, 430, 450, 440, 550, 500, 555, 555],
        },
        ...
        damageData: {
            base: 600,
            level: [0, 500, 520, 550, 590, 630, 650, 640, 600, 600, 655, 655],
        },
        fireRateDecreaseData: {
            base: 0,
            level: [0, 45, 45, 45, 45, 45, 45, 45, 45, 45, 45, 50]
        ...
        shieldData: {
            type: "energy",
            base: 47e3,
            level: [0, 5e3, 5e3, 6e3, 6e3, 7e3, 7e3, 8e3, 8e3, 9e3, 9e3, 10e3],
            regen: 0.05
        },
        ...
        damageData: {
            base: 720,
            level: [0, 80.4, 80.4, 80.4, 80.4, 80.4, 80.4, 80.4, 80.4, 180, 360, 600]
        },
        ...
        damageData: {
            base: 1440,
            level: [0, 160.8, 160.8, 160.8, 160.8, 160.8, 160.8, 160.8, 160.8, 360, 720, 1200]
        },
        ...
        damageData: {
            base: 360,
            level: [0, 36, 72, 72, 108, 108, 126, 126, 162, 162, 216, 216],
        },
        defenseBypassData: {
            base: .1,
        ...
        damageData: {
            base: 576,
            level: [0, 57 ,115 ,115, 172, 172, 201, 201, 259, 259, 345, 345],
        },
        defenseBypassData: {
            base: .1,
            level: [0, 0.03, 0.03, 0.06, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.09],
    ...
    makeNewSpecialAddiction("Green Circle", {
        ...
        healingAuraData: {
            base: 5e3,
            level: [0, 500, 500, 550, 600, 650, 650, 700, 700, 700, 800, 800]
        },
        moduleSlots: 4,
        tier: 4,
        borderColor: "#ffff00"
    ...
    makeNewSpecialAddiction("Tan Pentagon", {
        ...
        ability: {
            ...
            damageData: {
                base: 667,
                level: [0, 167, 167, 177, 177, 177, 199, 199, 233, 233, 233, 267],
            },
            lastingTime: 12e3,
            reload: 4e3
        },
    ...
    function upgradeWeapon(weapon, currentIndex, weapons, noEz, isBOT, shape, slot, inInventory) {
        ...
        if (weapon.baseShielding) {
            if (weapon.level < 12) {
                ...
                weapon.baseShielding.health *= weapon.level == 13 ? 1.5 : 1.2;
            }
        }
    ...
    function setUpPlayersData(gameMode, spawnLocations) {
        ...
        for (let i = 0; i < 8; i++) {
            ...
            if (REALSHAPE) {
                ...
                INGAMESIDSSSS++;
                newShape.inGameSid = INGAMESIDSSSS;
                if (gameMode == 3) {
                    newShape.x = Math.random() * mapInfo.x;
                    if (player.mapID == 1) {
                        newShape.y = Math.randInt((2500 + newShape.scale * 2), mapInfo.y - (2500 + newShape.scale * 2));
                    }else {
                    ...
                    newShape.x = spawnLocations[0][spawnLocations[1]].x;
                    newShape.y = spawnLocations[0][spawnLocations[1]].y;
                }
                ...
                for (let t = 0; t < weapons.length; t++) {
                    ...
                    if (!newWeapon.baseShielding) newShape.weapons.push(newWeapon);
                }
                ...
                for (let i = 0; i < weapons.length; i++) {
                    if (weapons[i].baseShielding) {
                        if (tmpShields[weapons[i].baseShielding.health] == null) {
                            tmpShields[weapons[i].baseShielding.health] = 1;
                        } else {
                            tmpShields[weapons[i].baseShielding.health]++;
                        }
                    }
                }
            ...
            for (let tt = 0; tt < (gameMode == 3 ? 10 : 11); tt++) {
                for (let i = 0; i < (players[0].robots.length * (gameMode == 3 ? 2 : 1)); i++) {
                    ...
                    if (gameMode == 3) {
                        ...
                        newShape.x = spawnLocations[0][index].x;
                        newShape.y = spawnLocations[0][index].y;
                    }
                    newShape.weapons = [];
    ...
    function buildMap() {
        ...
        document.getElementById("mapName").innerHTML = `Map: ${map.name} (ID: ${spawnid})`;
        let spawnLocations = [];
        mapInfo.x = map.x;
        mapInfo.y = map.y;
    ...
    function upgradeShape(shape, noEz, isBOT) {
        ...
        if (Shape.healingAuraData) {
            if (shape.level < 12) {
                ...
                shape.healingAura *= shape.level == 13 ? 1.5 : 1.2;
            }
        }
    ...
    function doMicrochipStuff(element, button, shape) {
        ...
        Microchip slots: ${Math.min(8, shape.level)}/8
        </div>
    ...
    function doLootboxAnimation(rewards, reward) {
        ...
        for (let i = 0; i < rewards.length; i++) {
            ...
            <div style="color: ${rewards[i] == reward ? "#000" : indexx % 2 ? "#fff" : "#000"}; font-size: 20px; display: ${tokenThing[rewards[i].token] ? "block" : rewards[i].ag ? "block" : rewards[i].au ? "block" : rewards[i].keys ? "block" : "none"}; position: absolute; bottom: 5px; right: 5px;">
            ${abbreviateNumber(rewards[i].amount)}
            </div>
            </div>
            `;
    ...
    function fireWeapon(weapon, shape, isAlly) {
        if ((shape.isMe ? true : shape.target)) {
            ...
            let scale = 0;
            scale = 15;
            if (weapon.name == "Blaze" || weapon.name == "Ember" || weapon.name == "Toxin" || weapon.name == "Bane") {
                scale = 30;
    ...
    function obtainBattleRewards(result, oldYAY, rewardsMulti) {
        ...
        for (let i = 0; i < result.kills; i++) {
            total.gold += (total.gold < 25) ? ((rewardsMulti == 2 || rewardsMulti == 0.5) ? 1.25 : 0.75) : ((rewardsMulti == 2 || rewardsMulti == 0.5) ? 1.75 : 0.25);
        }
        total.gold = Math.floor(total.gold);
        total.gold += Math.floor(Math.abs(result.dmg) / ((rewardsMulti == 2 || rewardsMulti == 0.5) ? 75000 : 100000));

        for (let i = 0; i < result.kills; i++) {
            if (total.keys >= 50) {
                total.keys += (rewardsMulti == 2 || rewardsMulti == 0.5) ? 0.1 : 0.075;
            } else if (total.keys >= 25) {
                total.keys += (rewardsMulti == 2 || rewardsMulti == 0.5) ? 0.25 : 0.1;
            } else {
                total.keys += (rewardsMulti == 2 || rewardsMulti == 0.5) ? 0.5 : 0.25;
            }
        }
        total.keys = Math.min(Math.floor(total.keys), 1000);

        total.oxp = result.kills * ((rewardsMulti == 2 || rewardsMulti == 0.5) ? 4 : 2);
        ...
        if (gameMode == 2 || gameMode == 3) {
            ...
            for (let i = 0; i < enemies.length; i++) {
                ...
                if (robot) {
                    ...
                    ${robot.name.length > 14 ? (robot.name.slice(0, 11) + (robot.name.includes("p2w") ? "_p2w" : "")) : robot.name}
                    </div>
    ...
    function addGrayDamage(shape, amount, graydmg) {
        ...
        if (shape.effects && shape.effects.find(e => e.name == "stampede")) {
            ...
            grayDmg /= 4;
        } else if (shape.name && shape.name.includes("Orange Circle")) {
            grayDmg /= 1.6;
        }
    ...
    function doModulesStuff(robot, delta) {
        ...
        if (robot.effects.find(e => e.name == "last stand") && robot.grayDamage > robot.maxhealth - (robot.lastStandThreshold * robot.maxhealth)) {
            ...
            if (bullet.dmg > 0) {
                ...
                if (bullet.dotEffect) {
                    if (bullet.dotEffect.resetDOT) {
                        robot.effects.filter(e => e.name == "dot").forEach(e => {
                            if (e.oldLastTime) {
                ...
                if (robot.health <= 0 && hadHealth && !robot.revive) {
    ...
    function doEffectStuff(robot, delta, isAlly) {
                ...
                if (effect.lastTime > 0) {
                    ...
                    if (effect.name == "cold pulse") {
                        ...
                        if (effect.healOverTime <= 0) {
                            ...
                            robot.grayDamage = Math.max(robot.grayDamage - (robot.grayDamage * .15), 0);
                            changeHealth(robot, {
                                amount: robot.maxhealth * .25
                            }, robot.isMe, robot);
                        }
                    }
                }
        ...
        let reinforceHull = robot.effects.find(e => robot.ability && e.name == "defense points" && e.abilityEffect == robot.ability.name);
        if (robot.isFREEZE && reinforceHull) {
            let effect = reinforceHull;
            if (robot.abilityLast != null && robot.abilityLast != 0) {
                robot.abilityLast = effect.lastTime;
            }
        }
        let ultimateMending = robot.effects.find(e => e.name == "Ultimate Mending");
        if (robot.isFREEZE && ultimateMending) {
            let effect = ultimateMending;
            if (robot.abilityLast != null && robot.abilityLast != 0) {
                robot.abilityLast = effect.lastTime;
            }
        }
        ...
        for (let i = 0; i < robot.weapons.length; i++) {
            ...
            if (weapon.continuousReload) {
                ...
                if (weapon.ammo > 0 && !robot.isFREEZE && (robot.isMe ? keysPressed[32] : robot.fireWeapon) && Date.now() - weapon.lastFire >= weapon.fireRate) {
                    ...
                    } else if (weapon.name == "Pantagruel" || weapon.name == "Gargantua") {
                ...
                if (weapon.ammo < weapon.maxammo) {
                    ...
                    if (Date.now() - weapon.lastChange >= (weapon.reload * robot.reloadMoveMulti)) {
                        ...
                        if (weapon.name == "Pantagruel" || weapon.name == "Gargantua") {
                            weapon.ammo = Math.min(weapon.ammo + 20, weapon.maxammo);
                        } else if (weapon.name == "Avalanche" || weapon.name == "Rime" || weapon.name == "Glacier") {
                ...
                if ((robot.isMe ? robot.deltaTimer <= 0 : deltaTimer <= 0)) {
                    ...
                    for (let i = 0; i < 4; i++) {
                        ...
                        projectiles.push({
                            ...
                            range: robot.name == "Ultimate Tan Pentagon" ? 2e3 : 800,
                            dir: dir,
                ...
                if (player && players[i].isAlly == isAlly) {
                    if (Math.hypot(player.y - robot.y, player.x - robot.x) <= 600 + player.scale) {
                        if (!player.isMe && robot.effects.find(e => e.name == "Ultimate Mending")) {
                            player.grayDamage = Math.max(0, player.grayDamage - (player.grayDamage * .3));
                        }
                        changeHealth(player, {
                            amount: robot.healingAura * (robot.effects.find(e => e.name == "Ultimate Mending") ? 25 : 1)
                        }, robot.isMe, robot);
                    }
                }
            }
    ...
    function doOtherBotStuff(robot, isAlly) {
        ...
        if (robot.ability) {
            ...
            if (["Reinforce Hull", "Cold Pulse", "Divine Judgement", "Full Action", "Stealth", "Domain Expansion: Infinite Void", "Paladin", "Dragon Flight", "Phase Shift", "Self Heal", "Retribution"].includes(abilityName) && Date.now() - robot.damagedTime <= 50) {
            ...
            if (robot.revive && !robot.kill) {
                ...
                if(robot.isMe) {
                    ...
                    if (!hasRobots) {
                        document.getElementById("chooseSlot").style.bottom = `-200px`;
                        document.getElementById("mapName").style.display = "none";
                        endGame([...players], (player.gameMode == 2 || player.gameMode == 3) ? .5 : null);
                    }
                    updateChooseSlots();
                }else {
                    ...
                    if (!players[index].robots[players[index].robotIndex]) {
                        ...
                        if (haveEnemyes) {
                            ...
                            document.getElementById("healthBar").style.display = "none";
                            document.getElementById("chooseSlot").style.bottom = "-200px";
                            endGame([...players], player.gameMode == 3 ? 15 : 3);
                        }
                    }
                }
            }
    ...
    function changeHealth(object, { amount, graydmg, onDamageHealBack, isDotDamage, defensePointsBypass, bypassReflector, damageTypeName }, isPlayer, doer, noDefense) {
        try {
            ...
            if (amount < 0 && onDamageHealBack && doer) {
                doer.grayDamage = Math.max(doer.grayDamage - Math.abs(amount * onDamageHealBack) * .75, 1);
                changeHealth(doer, {
            ...
            if (amount != 0) {
                ...
                if (amount < 0 && object.effects && !object.effects.find(e => e.name == "cooldown timer" && e.onDamageHealShield == "Ultimate Green Circle") && object.isMe && object.name == "Ultimate Green Circle") {
                    if (object.damageTokenHAHA == null) object.damageTokenHAHA = 0;
                    object.damageTokenHAHA += Math.abs(amount);
                    if (object.damageTokenHAHA >= 90e3) {
                        object.damageTokenHAHA = 0;
                        object.shields.push({
                            type: "purple",
                            health: 0,
                            lastTime: 3e3
                        ...
                        object.effects.push({
                            name: "cooldown timer",
                            onDamageHealShield: object.name,
                            lastTime: 7e3
                        });
                    }
                    setTimeout(() => {
                        object.damageTokenHAHA = Math.max(0, object.damageTokenHAHA - Math.abs(amount));
                    }, 7e3);
                }
                if (object.turnDmgIntoDOT && amount < 0 && doer && !noDefense) {
                    let duration = object.effects.find(e => e.name == "stampede") ? 7 : object.name == "Orange Circle" ? 15 : 20;
                ...
                if (object.health <= 0 && !object.revive) {
    ...
    function antiTier4_5(bullet, enemy) {
        ...
        if (enemy.maxhealth >= 350e3) {
            ...
            amount += Math.min(Math.floor(mm / 25e3) * .1, 250);
        }
            ...
            if (enemy && playerRobot) {
                ...
                if (!enemy.isFREEZE && !playerRobot.invis) {
                    if (enemy.name == "Burner Circle") {
                        ...
                        if (Date.now() - enemy.lastFire >= 50) {
                            enemy.lastFire = Date.now();
                            let dmg = enemy.name == "Level 10 Boss" ? 240 : 300;
                            projectiles.push({
                                x: enemy.x,
                                y: enemy.y,
                                oldX: enemy.x,
                ...
                for (let t = 0; t < touchBullets.length; t++) {
                    ...
                    if (bullet.dmg > 0) {
                        ...
                        if (bullet.rustEffect) {
                            if (enemy.effects.filter(e => e.name == "rust" && e.effectID == "tamer").length < 30) {
                                enemy.effects.push({
                                    neg: true,
                                    name: bullet.rustEffect.name,
                                    power: bullet.rustEffect.power,
                        ...
                        if (bullet.dotEffect) {
                            if (bullet.dotEffect.resetDOT) {
                                enemy.effects.filter(e => e.name == "dot").forEach(e => {
                                    if (e.oldLastTime) {
                                        e.lastTime = e.oldLastTime;
                                    }
                                });
    ...
    function doMoveStuff(robot, isAlly) {
        ...
        let TARGET = null;
        if ((player.gameMode == 3 ? true : !nearestBeacon) && Math.hypot(nearestEnemy.y - robot.y, nearestEnemy.x - robot.x) >= nearestEnemy.scale + robot.scale + 20) {
            TARGET = nearestEnemy;
                ...
                for (let i = 0; i < buildings.length; i++) {
                    ...
                    if (obj.name == "coll rect") {
                        ...
                        if (distance <= 25 + robot.scale) {
                            if (obj.middleX) {
                                if ((TARGET.y <= obj.y && robot.y >= obj.y) || (TARGET.y >= obj.y && robot.y <= obj.y)) {
                                ...
                                if ((TARGET.x >= obj.x && obj.x >= robot.x) || (TARGET.x <= obj.x && obj.x <= robot.x)) {
                                    if (obj.onlyDir != null) return obj.onlyDir;
    ...
    function updateMiniMap() {
        ...
        for(let i = 0; i < players.length; i++) {
            ...
            if (player) {
                ...
                let color = player.isMe ? "#0f0" : players[i].isAlly ? "#fff" : "#f00";
            ...
            if (player && !player.isFREEZE && (player.isMe ? keysPressed[32] : player.fireWeapon)) {
                ...
                player.weapons.forEach(weapon => {
                    if (weapon.canFire || (weapon.continuousReload && weapon.ammo > 0)) {
                        if (["Eagle", "Hawk"].includes(weapon.name)) {
                        ...
                        } else if (["Pantagruel", "Gargantua"].includes(weapon.name) && !rendered) {
                            rendered = true;
                            let Enemies = [];
                            ...
                            if (Player.gameMode == 2 || Player.gameMode == 3) {
                                ...
                                for(let t = 0; t < enemies.length; t++) {
                                    ...
                                    if (ROBOTBOTBT) {
                                        let dir = Math.atan2(ROBOTBOTBT.y - player.y, ROBOTBOTBT.x - player.x);
                                        console.log(Math.getAngleDist(direction, dir) <= angle, dist(ROBOTBOTBT, player) <= weapon.range + ROBOTBOTBT.scale);
                            ...
                            Enemies.forEach(item => {
                                ...
                                ctx.save();
                                ctx.lineWidth = 16;
                                ctx.strokeStyle = players[i].isAlly ? "rgb(0, 150, 0, .6)" : "rgb(255, 165, 0, .6)";
                                ctx.beginPath();
                                ctx.moveTo(player.x - offset.x, player.y - offset.y);
    ...
    function updateGame() {
        ...
        if (player.gameMode >= 0) {
            ...
            for (let i = 0; i < bombeffect.length; i++) {
                ...
                if (effect) {
                    effect.scale += (effect.blastttt ? 4 : effect.color ? effect.color == "stamp" ? 1.5 : 3.84 : (effect.doFaster || effect.maxScale == 500) ? 1.2 : 0.32) * delta;
            ...
            for (let i = 0; i < KILLLOGS.length; i++) {
                ...
                if (log.weapon && log.weapon.level) {
                    let nameOne = {
                        color: log.attacker.isAlly ? "#00f" : "#f00",
                        name: log.attacker.name
                    };
                    let nameTwo = {
                        color: log.victim.isAlly ? "#00f" : "#f00",
