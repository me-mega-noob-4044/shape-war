(function () {
   ...
   - Balance Unit Description Fixed<br><br>
    ...
    var shapeData = [{
        ...
        ability: {
            ...
            After 6 seconds of stealth, cools down for 16 seconds.
            `,
    ...
    function renderPlayer() {
        ...
        if (player.robotIndex >= 0) {
            ...
            if (robot.health > 0) {
                ...
                ctx.globalAlpha = robot.invis ? 0.025 : 1;
    ...
    function updatePlayer(delta) {
        ...
        if (Player.robotIndex >= 0) {
            ...
            for (let i = 0; i < robot.shields.length; i++) {
                ...
                <div style="position: absolute; top: 0px; left: 0px; width: ${100 * (shield.health / shield.maxhealth)}%; height: 100%; background-color: ${shield.type == "yellow" ? "#ffff00" : "#02ccaa"};">
                </div>
                ...
                if (shield.health > 0) {
                    let touchBullets = projectiles.filter(e => !e.isAlly && e.projType != shield.type && Math.hypot(e.y - robot.y, e.x - robot.x) <=  20 + (e.scale*1.5) + robot.scale);
            ...
            if (robot.ability && !robot.isFREEZE) {
                ...
                if (keysPressed[69]) {
                    ...
                    if (robot.ability.name == "Stealth" || robot.ability.name == "Ultimate Defense" || robot.ability.name == "Self Heal" || robot.ability.name == "Dragon Flight" ||  robot.ability.name == "Shield Regeneration" || robot.ability.name == "Full Action") {
        ...
        for (let i = 1; i < players.length; i++) {
            ...
            if (robot) {
                ...
                for (let tt = 0; tt < robot.shields.length; tt++) {
                    ...
                    if (shield.health > 0) {
                        let touchBullets = projectiles.filter(e => e.isAlly != players[i].isAlly && e.projType != shield.type && Math.hypot(e.y - robot.y, e.x - robot.x) <= 20 + (e.scale*1.5) + robot.scale);
                        for (let t = 0; t < touchBullets.length; t++) {
                            shieldEffects.push({
                                x: robot.x,
                                y: robot.y,
            ...
            for (let i = 0; i < shieldEffects.length; i++) {
                ...
                if (effect) {
                    ...
                    if (true) {
                        ...
                        ctx.lineWidth = 12;
                        ctx.strokeStyle = effect.type == "energy" ? "#0000ff" : "#ffff00";
                        ctx.beginPath();
