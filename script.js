(function () {
   ...
   - Bug Fixes<br><br>
    ...
    function betterEquipShape(slot, oldShape, unequipedShapes) {
        ...
        filteredRobots = filteredRobots.sort((a, b) => b.tier - a.tier).sort((a, b) => b.level - a.level);
    ...
    function updatePlayer(delta) {
        ...
        if (Player.robotIndex >= 0) {
                ...
                if (effect) {
                    ...
                    if(effect.lastTime > 0) {
                        if (effect.name == "cold pulse") {
                            ...
                            if (effect.dmgOverTime == null) effect.dmgOverTime = 0;
                            effect.dmgOverTime -= delta;
                            robot.dotDamage += Math.floor(effect.lastTime / 1000) * effect.dmg;
                            if (effect.dmgOverTime <= 0) {
            ...
            for (let i in effectNames) {
                ...
                <div style="position: absolute; top: 0px; left: 5px; height: 40px; width: 40px; background-size: 40px 40px; background-image: url('${i == "freezing" ? "./images/weapons/rime.png" : i == "dot" ? "./images/weapons/viper.png" : i == "last stand" ? "./images/modules/last_stand.png" : i == "phase shift" ? "./images/phase_shift.png" : i == "dash" ? "./images/dash.png" : i == "stealth dash" ? "./images/stealth.png" : i == "slowdown" ? "./images/slowdown_effect.png" : "./images/cold_pulse.png"}');">
                </div>
        ...
        try {
            ...
            if (amount != 0) {
                ...
                if (object.turnDmgIntoDOT && amount < 0 && doer && !noDefense) {
                    let duration = object.name == "Orange Circle" ? 30 : 10;
                    object.effects.push({
                        name: "dot",
