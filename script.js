        ...
        constructor(data, slot, dontSID) {
            ...
            if (data.ability) {
                if (true) {
                    ...
                    if (data.ability.name == "Stealth Dash" || data.ability.name == "Phase Shift" || data.ability.name == "Dash") {
