(function () {
    ...
    var shapeData = [{
        ...
        <br><br>
        Recommended Equipment: x1 Atomizer + x2 Nucleon
        `,
        buyDesc: `
        <br><br>
        Cost: 500.0M Silver + 100.0K Gold
        `,
        healthData: {
            base: 174e3,
    ...
    var moduleData = [{
        ...
        imageSource: "./images/balance_unit.png",
        cost: {
            sliver: 0,
            gold: 5e3
        }
    ...
    document.getElementById("lootBoxToggle").onclick = function () {
        ...
        <div style="position: absolute; top: 340px; left: 340px; width: 300px; height: 300px; background-image: url('${lootboxes[3].source}');">
        <div style="width: 100%; text-align: center; color: #fff; font-size: 30px;">
        Diamond Box
        </div>
        ...
        if (Player.robotIndex >= 0) {
                ...
                if (effect) {
                    ...
                    if (effect.name == "cold pulse") {
                        ...
                        if(effectNames["dot"] == null) {
                            ...
                            if(effectNames["dot"].orginal < effect.lastTime) {
                                effectNames["dot"].orginal = effect.lastTime;
                            }
                        }
                        if (effect.dmgOverTime == null) effect.dmgOverTime = 0;
                        effect.dmgOverTime -= delta;
            ...
            if (robot.ability && !robot.isFREEZE) {
                ...
                if (keysPressed[69]) {
                    ...
                    if (robot.ability.name == "Ultimate Defense" || robot.ability.name == "Self Heal" || robot.ability.name == "Dragon Flight" ||  robot.ability.name == "Shield Regeneration" || robot.ability.name == "Full Action") {
    ...
    function changeHealth(object, amount, isPlayer, doer, noDefense) {
        try {
            ...
            if (!object.turnDmgIntoDOT && amount < 0) {
                object.grayDamage += Math.abs(amount * (object.name == "Orange Circle" ? .25 : .4));
            }
            if (amount != 0) {
        ...
        for (let i = 1; i < players.length; i++) {
            ...
            if (robot) {
                ...
                if (robot.ability && !robot.isFREEZE) {
                    ...
                    }else if(robot.ability.name == "Ultimate Defense" || robot.ability.name == "Shield Regeneration" || robot.ability.name == "Full Action") {
