   ...
   - Bug Fixes<br><br>
            ...
            if (data.ability) {
                if (true) {
                    ...
                    if (data.ability.name == "Paladin" || data.ability.name == "Stealth Dash" || data.ability.name == "Phase Shift" || data.ability.name == "Dash" || data.ability.name == "Fortify") {
                        ...
                        if (data.ability.name == "Grand Fortitude" || data.ability.name == "Overload" || data.ability.name == "Cold Pulse" || data.ability.name == "Dragon Flight" || data.ability.name == "Retribution" || data.ability.name == "Stampede") {
                            this.ability.dmg = data.ability.damageData ? data.ability.damageData.base : data.ability.dmg;
                            if (data.ability.name == "Grand Fortitude" || data.ability.name == "Overload" || data.ability.name == "Stampede" || data.ability.name == "Dragon Flight" || data.ability.name == "Retribution") {
                                this.ability.lastingTime = data.ability.lastingTime;
    ...
    document.getElementById("offersToggles").onclick = function () {
        if(tasks.length) {
            ...
            document.getElementById("sideDisplay").innerHTML += `
            <div style="position: absolute; top: ${50+(tasks.length * 140)}px; opacity: 0; pointer-events: none;">
            s
            </div>
            `;
            for(let i = 0; i < tasks.length; i++) {
    ...
    function generateRandomName() {
        let isP2W = Math.random() < (player.league >= 51e2 ? 0.25 : 0.05);
        let name = "";
    ...
    function displayOperation(XDDDD) {
        ...
        <hr>
        <div style="position: absolute; left: ${(window.innerWidth - 375) / 2 - 25}px; top: ${window.innerHeight / 2 - 170}px;">
        Lvl ${operationData.currentIndex + 1}
        </div>
        <div style="position: absolute; left: ${(window.innerWidth - 375) / 2 - 300}px; top: ${window.innerHeight / 2 - 140}px; height: 20px; border-radius: 12px;  overflow: hidden; width: 600px; background-color: rgb(0, 0, 0, 0.4);">
        ...
        <div id="rewards" style="position: absolute; top: ${window.innerHeight / 2 - 100}px; overflow-x: scroll; height: 220px; width: ${window.innerWidth - 375}px; background-color: rgb(0, 0, 0, .3);">
        </div>
        ...
        <div id="collectAll" style="color: #fff; border-radius: 12px; font-size: 35px; width: 200px; text-align: center; height: 50px; background-color: rgb(0, 0, 0, 0.4); position: absolute; left: ${(window.innerWidth - 375) / 2 - 100}px; top: ${window.innerHeight / 2 + 140}px;">
        Collect All
        </div>
