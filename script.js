        ...
        constructor(data, slot, dontSID) {
            ...
            if (data.ability) {
                if (true) {
                    ...
                    if(data.ability.name == "Stealth Dash") {
    ...
    function updatePlayer(delta) {
        ...
        if (Player.robotIndex >= 0) {
            ...
            for (let i in effectNames) {
                ...
                <div style="position: absolute; top: 0px; left: 5px; height: 40px; width: 40px; background-size: 40px 40px; background-image: url('${i == "dot" ? "./images/weapons/viper.png" : i == "last stand" ? "./images/modules/last_stand.png" : i == "stealth dash" ? "./images/stealth.png" : i == "slowdown" ? "./images/slowdown_effect.png" : "./images/cold_pulse.png"}');">
                </div>
