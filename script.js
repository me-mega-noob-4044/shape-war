...
*/
    ...
    var microshipData = [{
        ...
        name: "Traditionalist",
        fontSize: 12,
        onlyFor: ["Orange Circle", "Dark Gray Circle"],
        ...
        name: "Ghost",
        onlyFor: ["Orange Circle", "Red Heptagon"],
    ...
    function fireWeapon(weapon, shape, isAlly) {
        if ((shape.isMe ? true : shape.target)) {
            ...
            if (weapon.name == "Punisher") {
            ...
            } else if (weapon.name == "Shocker" || weapon.name == "Reaper" || weapon.name == "Lance" || weapon.name == "Glaive") {
                let isL = ((weapon.name == "Lance" || weapon.name == "Glaive") ? true : false);
                let multi = 1;
                ...
                projectiles.push({
                    ...
                    dir: dir,
                    isAlly: isAlly,
                    color: isL ? "./images/bullets/energy_bullet.png" : "./images/bullets/bullet.png",
                    owner: shape,
