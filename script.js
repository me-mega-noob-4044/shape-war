(function () {
    ...
    Beta V39 (Nov 9, 2023 - Nov 11, 2023):<br>
...
*/
    ...
    function buildMap() {
        ...
        return [spawnLocations, Math.randInt(0, 1)];
    }
                ...
                for (let i = 0; i < buildings.length; i++) {
                    ...
                    if (obj.name == "coll rect") {
                        ...
                        if (distance <= 25 + robot.scale) {
                            if (obj.middleX) {
                                if (TARGET.x <= obj.x || TARGET.x >= obj.x) {
                                ...
                                if (TARGET.y >= obj.y || TARGET.y <= obj.y) {
                                    if (obj.onlyDir != null) return obj.onlyDir;
    ...
    function updateMiniMap() {
        ...
        for(let i = 0; i < players.length; i++) {
            ...
            if (player) {
                ...
                let color = players[i].isAlly ? "#fff" : "#f00";
